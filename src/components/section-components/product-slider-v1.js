			    ...
			    <div className="row">
			      <div className="col-lg-12">
			        <div className="section-title-area ltn__section-title-2--- text-center">
			          <h6 className="section-subtitle section-subtitle-2 ltn__secondary-color">Propriedades</h6>
			          <h1 className="section-title">Lançamentos recentes</h1>
			        </div>
			      </div>
			    </div>
			        ...
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            ...
			            <div className="product-badge">
			              <ul>
			                <li className="sale-badge bg-green">Alugar</li>
			              </ul>
			            </div>
			      ...
			      <div className="col-lg-12">
			        <div className="ltn__product-item ltn__product-item-4 text-center---">
			          <div className="product-img go-top">
			            ...
			            <div className="product-badge">
			              <ul>
			                <li className="sale-badge bg-green---">À venda</li>
			              </ul>
			            </div>
			            <div className="product-img-location-gallery">
			              <div className="product-img-location">
